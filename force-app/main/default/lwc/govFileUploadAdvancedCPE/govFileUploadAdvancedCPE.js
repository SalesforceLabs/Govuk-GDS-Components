...
const VALIDATEABLE_INPUTS = ["uxgovuk-fsc_flow-combobox"];

export default class GovFileUploadAdvancedCPE extends LightningElement {
    ...
    basicConfiguration = [
        ...
        {label: 'More Resources', helpText: 'https://designsystemcatalogue.my.site.com/components/s/ <br> https://developer.salesforce.com/docs/component-library/bundle/lightning-file-upload/documentation'},
    ];
    ...
    renderedCallback() {
        if (!this.rendered) {
            this.rendered = true;
            for (let flowCombobox of this.template.querySelectorAll('uxgovuk-fsc_flow-combobox')) {
